	...
	<Dialog :open="isRevealed" @close="confirm(false)" class="relative z-50">
		...
		<div class="fixed inset-0 flex items-center justify-center p-4">
			...
			<DialogPanel class="w-full max-w-sm rounded bg-white py-4 px-10">
				...
				>
				<DialogDescription>
					<p>This would remove something that you would like to see again. Are you sure?</p>
					<div class="flex justify-between mt-6 mb-2">
						<button class="btn-dummy bg-green-300" @click="confirm(true)">Yes</button>

						<button class="btn-dummy bg-red-300" @click="confirm(false)">No</button>
					</div>
				</DialogDescription>
			</DialogPanel>
		</div>
